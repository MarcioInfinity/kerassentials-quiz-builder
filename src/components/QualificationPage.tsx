...
export const QualificationPage = ({
  ...
  return <div className={cn("animate-fade-in text-center", className)}>
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-lg md:text-xl font-body text-foreground mb-4 sm:mb-6 leading-relaxed my-0 mx-0 px-0">
      ...
      <QuizButton onClick={handleCTAClick} size="lg" className="w-[90%] mt-5 text-lg sm:text-xl font-bold py-4 px-6 h-auto min-h-[70px] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl whitespace-normal sm:py-0 mx-[26px] my-0 sm:px-[12px]">Claim Your Discount Coupon for Kerassentials™</QuizButton>
    </div>;
};