...
export const QualificationPage = ({
  ...
  return <div className={cn("animate-fade-in text-center", className)}>
      <div className="mb-8">
        ...
        <p className="text-lg font-body font-bold text-foreground mb-4">Your official exclusive discount has been automatically activated for the Kerassentials ® formula.</p>
      ...
      <QuizButton onClick={handleCTAClick} size="lg" className="text-xl font-bold px-12 py-6 h-auto min-h-[70px] hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
